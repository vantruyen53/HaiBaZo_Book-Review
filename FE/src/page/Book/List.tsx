...
export default function BookList() {
  const [data, setData] = useState<{ content: BookDTO[]; totalPages: number }>({ content: [], totalPages: 0 });
  ...
  return (
    <div style={{padding:20}}>
      <h3 style={{color:'#555', marginBottom:10}}>Books &gt; List</h3>
